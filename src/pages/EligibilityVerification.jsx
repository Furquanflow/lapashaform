     ...
     <div>
      <Grid className='form-section'>
        ...
        <Grid className='text-box txt-fld-space'>
         <p>I am aware that federal law provides for imprisonment and/or fines for false statements, or the use of false documents, in
          connection with the completion of this form. I attest, under penalty of perjury, that this information, including my selection
           ...
           <Grid item xs={12}>
            <FormControlLabel control={<Checkbox />} label="1. A citizen of the United States" />
            </Grid>
            <Grid item xs={12}>
            <FormControlLabel control={<Checkbox />} label="2. A noncitizen national of the United States (See Instructions.)" />
            </Grid>
            <Grid item xs={6}>
            <FormControlLabel control={<Checkbox />} label="3. A lawful permanent resident (Enter USCIS or A-Number.)" />
            </Grid>
            <Grid item xs={6}>
            <TextField className='txt-width' id="standard-basic" label="" variant="standard" />
            </Grid>
            <Grid item xs={8}>
            <FormControlLabel control={<Checkbox />} label="4. A noncitizen (other than Item Numbers 2. and 3. above) authorized to work until (exp. date, if any)" />
            </Grid>
            <Grid item xs={4}>
            <TextField className='txt-width' id="standard-basic" label="" variant="standard" />
            </Grid>
       ...
       <Grid container spacing={3} columns={12} className='btm-button'>
        <Grid item xs={6}></Grid>
        <Grid item xs={6}><Button variant="contained" className='right-btn' href="/supplementa">Next</Button></Grid>
        </Grid>

          ...
          <Grid className="form-inner">
            ...
            <Grid className="form-points policy-form-title">
              <Typography variant="h4">
                LAPASHA HOSPITALITY GROUP EMPLOYEE HANDBOOK Effective 6/__/2023
              </Typography>
              <Typography variant="body">
                If English is not your native language and/or you are unable to
                read and understand the Employee Handbook written in English,
                you have a right to request a translation of the policies
                contained in this Handbook. You should request a translation of
                these policies if you are unable to read and understand English
                because you must understand the policies contained in the
                Handbook and agree to be bound by the policies to be employed by
                the Company
              </Typography>
              <Typography variant="body">
                ...
                derecho de solicitar una traducción de las polizas contenidas en
                este Guía. Usted debe de solicitar una traducción de estas
                polizas si usted no puede leer y entender inglés, porque usted
                debe de entender las polizas contenidas en la Guía y acordar en
                ser atado a las polizas para ser empleado de el compania.
              </Typography>
            </Grid>
            ...
            <Grid className="welcom-blk">
              ...
              <Typography variant="body">
                ...
                providing a warm and welcoming atmosphere. From the rich flavors
                of the Mediterranean to the timeless tradition of hookah, we
                strive to exceed expectations and become the premier destination
                for a memorable dining experience.
              </Typography>
              <Typography variant="body">
                Our success as a team depends on clear communication and
                understanding. To help you with some basics, we’ve prepared this
                policy manual which you should read and refer to often. If you
                have questions about our policies, please don’t hesitate to ask
                a manager.
              </Typography>
              <Typography variant="body">
                These policies set the ground rules for a safe and pleasant work
                environment. In these pages, you will learn what we expect from
                you. Your adherence to these policies may affect your
                performance evaluations and continued employment. You will also
                learn what you can expect from us, such as certain rights and
                benefits; and how to resolve conflicts if they arise.
                Ultimately, these policies help our team focus on the reason we
                come to work each day – our guests.
              </Typography>
              <Typography variant="body">
            ...
            <Grid className="points-sec">
              ...
              <Typography variant="body">
                ...
                every circumstance or question regarding employment policies. As
                our organization continues to grow, the need may arise and The
                Company reserves the right to revise, supplement, or rescind any
                policies or portions of the employee manual from time to time as
                appropriate, in their sole and absolute discretion. Employees
                will, of course, be notified of any future changes to the manual
                as they occur.
              </Typography>
              <Grid className="points-blk">
                <Typography className="h6">A. Nature of Employment</Typography>
                <Typography variant="body">
                  Employees are an employee of the respective restaurant entity
                  by which they are employed. These entities are collectively
                  referred to as “the Company” or “Employer” through out this
                  handbook.
                </Typography>
                <Typography variant="body">
                ...
                <Typography variant="body">
                  <b>
                    ...
                    OR REPRESENTATIVE OF THE COMPANY IS AUTHORIZED TO ENTER INTO
                    AN AGREEMENT—EXPRESS OR IMPLIED—WITH ANY EMPLOYEE FOR
                    EMPLOYMENT FOR A SPECIFIED PERIOD OF TIME UNLESS SUCH AN
                    AGREEMENT IS IN A WRITTEN CONTRACT SIGNED BY THE HR
                ...
                <Typography variant="body">
                  ...
                  to engage in concerted protected activity for the purposes of
                  their mutual aid and/or protection. This manual is
                  confidential company information and company property.
                </Typography>
                <Typography variant="body">
                  These provisions supersede all existing policies and practices
                  and may not be amended or added to without the express written
                  approval of The Company’s President. The Company has the right
                  to unilaterally change or delete any practice, policy,
                  procedure, or rule within or not within this manual.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  to be bound by any laws to which it is not subject, submit to
                  the jurisdiction of any administrative agency responsible for
                  the enforcement of federal law, or submit to the jurisdiction
                  of any federal court interpreting such laws until such time as
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  requirements. Any employee who has been terminated and removed
                  from payroll must complete a new I-9 if the employee is
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  subpoena), responses to such inquires will confirm only dates
                  of employment, wage rates, and position(s) held. No employment
                  data will be released without a written authorization and
                  release signed by the individual who is the subject of the
                  inquiry. All job reference inquiries by prospective employers
                  should be directed to The Company’s President.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                <Typography className="h6">
                ...
                <Typography variant="body">
                  The Company relies upon the accuracy of information contained
                  ...
                  material omissions in any of this information or data may
                  result in the exclusion of the individual from further
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  pre-employment drug screen as a condition of employment prior
                  to their start date. The Company will not hire individuals who
                  test positive for the illegal use of a controlled or synthetic
                  substance.
                </Typography>
                <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  work, personal conflicts from outside work environment can be
                  carried into day-to-day working relationships. Therefore, The
                  Company discourages the employment of relatives, but will
                  permit such employment of relatives if: (1) such relationship
                  is fully disclosed; and (2) such employment is approved by
                  Management.
                </Typography>
                <Typography variant="body">
                  For the purpose of this policy, a relative is any person who
                  is related by blood or marriage, or whose relationship with
                  the employee is similar to that of persons who are related by
                  blood or marriage.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  What employees do on their own time away from work is private
                  unless it negatively impacts their performance in the
                  workplace. The manner in which you conduct yourselves at work
                  is subject to company policies and procedures. Consequently,
                  the Company strictly prohibits personal relationships of a
                  romantic nature between an employee and any other employee in
                  a supervisor position with relation to that employee. The
                  Company also strongly discourages peer to peer relationships
                  of a romantic nature.
                </Typography>
                <Typography variant="body">
                  While The Company reserves the right to terminate any employee
                  who violates this policy, The Company acknowledges such
                  relationships may occur. Any employee who becomes involved in
                  a romantic relationship with another employee shall
                  immediately disclose such relationship by contacting Human
                  Resources as set forth below depending on which location
                  employed:
                </Typography>
                ...
                <ul className="num-list">
                  ...
                  <li>
                    agrees to refrain from personal conduct on company premises
                    that creates tension with co-workers or causes other
                    employees to feel uncomfortable or offended; and
                  </li>
                  <li>
                    acknowledges that If a conflict of interest is present in a
                    relationship, The Company will endeavor to find a solution
                    to eliminate the conflict of interest so that one person is
                    no longer able to unduly influence or favor the other. (Such
                    solution may include transfer or relocation of one of the
                    employees to another department or location, or change the
                    reporting structure, if feasible and available. If
                    reasonable alternatives are not available or feasible, The
                    Company may require one or both of the employees to resign
                    or be terminated.)
                  </li>
                </ul>
              </Grid>
            ...
            <Grid className="points-sec">
              <Typography variant="h5">II. EMPLOYMENT STATUS</Typography>
              <Grid className="points-blk">
                <Typography className="h6">A. Employment Categories</Typography>
                <Typography variant="body">
                  It is the intent of The Company to clarify the definitions of
                  employment classifications so that employees understand their
                  ...
                  employment relationship at will at any time is retained by
                  both the employee and The Company. These categories are also
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  overtime pay under applicable federal and state wage and hour
                  laws. NONEXEMPT employees are entitled to overtime pay under
                  the specific provisions of federal and state laws. EXEMPT
                  employees are excluded from specific provisions of federal and
                  state wage and hour laws. The exemption applies to executive,
                  administrative and professional employees as defined by the
                  Federal Fair Labor Standards Act. Employees classified as
                  exempt are excluded from the payment of overtime and are paid
                  on a salary basis. An employee’s EXEMPT or NONEXEMPT
                  classification may be changed only upon written notification
                  by The Company.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  classified under one of the following 3 employment categories:
                </Typography>
                <Typography variant="body">
                  <b>REGULAR FULL-TIME</b> employees are those who are not in a
                  temporary status and who are regularly scheduled to work
                  ...
                  category includes employees who work an average of at least 30
                  hours or more per week as part of their work schedule.
                </Typography>
                <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  this provision, you will be paid a base hourly rate of $7.25.
                  Employer will claim a tip credit of $5.12 per hour and the
                  minimum cash wage (currently $2.13/hour) which is the maximum
                  allowed by federal law.
                </Typography>
                <Typography variant="body">
                  Under the Act, we are required to notify you of our intention
                  to utilize the tip credit. This provision serves as
                ...
                <Typography variant="body">
                  ...
                  IRS requires employees to report all of their tips as taxable
                  income on annual tax returns.
                </Typography>
                <Typography variant="body">
                  <b>Disputes </b> Employees who believe they have not received
                  all tips due to them should immediately report the issue to
                  the restaurant manager. If the restaurant manager does not
                  respond or address the issue the employee should report the
                  issue to Human Resources as follows:
                </Typography>
                <Grid container spacing={3} columns={12} className="email-blk">
                  <Grid item xs={4}>
                    <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  written or oral. The performance review process is also a tool
                  to evaluate the appropriateness of changes in an employee’s
                  wage rate, salary, or other compensation.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                <Typography className="h6">
                ...
                <Typography variant="body">
                  ...
                  permitted consistent with the laws of the State of Texas or in
                  which the employee is located.
                </Typography>
                <Typography variant="body">
                ...
                <Typography variant="body">
                  ...
                  regulations. This includes, but is not limited to, copies of
                  the current or stored OSHA 300 Logs as described in 29 CFR
                  1904.35 and certain records described in 1919.1020, Access to
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  Notify your supervisor or Administrator when there are changes
                  to the following:
                </Typography>
                <ul>
                  <li>Your name</li>
            ...
            <Grid className="points-sec">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  including employee classification. Management can identify the
                  programs for which you are eligible. Details of many of these
                  programs can be found elsewhere in the employee manual.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                ...
                <ul className="icon-list">
                  <li>
                    When any employee is working they can receive a 50% discount
                    on food.
                  </li>
                  <li>
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  for time off should be submitted to the location manager. Time
                  off shall be granted as per the staffing needs and schedule of
                ...
                <Typography variant="body">
                  ...
                  manager or Director of Operations in writing three weeks prior
                  to the anticipated vacation day, unless otherwise not
                  practicable.
                </Typography>
                <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  general description of their FMLA rights. In the event of any
                  conflict between this policy and the applicable law, employees
                  will be afforded all rights required by law. If you have any
                  questions, concerns or disputes with this policy, please
                  contact Management.
                </Typography>
                ...
                <Grid className="points-blk-inn">
                  ...
                  <ul>
                    ...
                    <li>
                      Have worked at least 1,250 hours for The Company over the
                      twelve (12) months preceding the date the leave would
                      commence.
                    </li>
                    <li>
                ...
                <Grid className="points-blk-inn">
                  ...
                  <ul>
                    ...
                    <li>
                      For any qualifying exigency arising out of the fact that a
                      spouse, child or parent is a military member on covered
                      active duty or on call to covered active duty status.
                    </li>
                    <li>
                ...
                <Grid className="points-blk-inn">
                  ...
                  <Typography variant="body">
                    ...
                    policy. Each time an employee takes leave, the company will
                    compute the amount of leave the employee has taken under
                    this policy in the last 12 months and subtract it from the
                    12 weeks of available leave, and the balance remaining is
                    the amount the employee is entitled to take at that time.
                  </Typography>
                  <Typography variant="body">
                    An eligible employee can take up to 26 weeks for the FMLA
                    military caregiver leave during a single 12-month period.
                    For this military caregiver leave, the company will measure
                    the 12-month period as a rolling 12-month period measured
                    forward. FMLA leave already taken for other FMLA
                    circumstances will be deducted from the total of 26 weeks
                    available.
                  </Typography>
                  <Typography variant="body">
                    Eligible spouses who both work for the company may only take
                    a combined total of 12 weeks of leave for the birth of a
                    child, adoption or placement of a child in foster care, or
                    to care for a parent (but not a parent "in-law") with a
                    serious health condition. Both may only take a combined
                    total of 26 weeks of leave to care for a covered injured or
                    ill service member (if each spouse is a parent, spouse,
                    child or next of kin of the service member).
                  </Typography>
                </Grid>
                <Grid className="points-blk-inn">
                  <Typography variant="h5">
                  ...
                  <Typography variant="body">
                    ...
                    workday, resulting in a reduced hour schedule. In all cases,
                    the leave may not exceed a total of 12 workweeks (or 26
                    workweeks to care for an injured or ill service member) in a
                    12-month period.
                  </Typography>
                  <Typography variant="body">
                  ...
                  <Typography variant="body">
                    ...
                    company and the employee must mutually agree to the schedule
                    before the employee may take the leave intermittently or
                    work a reduced-hour schedule. Leave for birth, adoption or
                    foster care of a child must be taken within one year of the
                  ...
                  <Typography variant="body">
                    ...
                    so as not to unduly disrupt the company's operations.
                  </Typography>
                </Grid>
                <Grid className="points-blk-inn">
                  <Typography variant="h5">
                  ...
                  <Typography variant="body">
                    ...
                    must provide the company with at least 30 days' notice. When
                    an employee becomes aware of a need for FMLA leave fewer
                    than 30 days in advance, the employee must provide notice of
                    the need for the leave either the same day the need for
                    leave is discovered or the next business day. When the need
                    for FMLA leave is not foreseeable, the employee must comply
                    with the company's usual and customary notice and procedural
                  ...
                  <Typography variant="body">
                    ...
                    employee with a Notice of Eligibility and Rights and request
                    a medical certification or other supporting documentation as
                    necessary.
                  </Typography>
                </Grid>
                <Grid className="points-blk-inn">
                ...
                <Grid className="points-blk-inn">
                  ...
                  <Typography variant="body">
                    ...
                    conditions as if the employee was continuously at work.
                    While on paid leave, the employer will continue to make
                    payroll deductions to collect the employee's share of
                    ...
                    accounting department by the 15th day of each month. If the
                    payment is more than 30 days late, the employee's health
                    care coverage may be dropped for the duration of the leave.
                  </Typography>
                  <Typography variant="body">
                    The company will provide 15 days' notification prior to the
                  ...
                  <Typography variant="body">
                    ...
                    beyond the employee's control, the company will require the
                  ...
                  <Typography variant="body">
                    ...
                    continuation of such benefits and pay his or her portion of
                    the premiums, or the company may elect to maintain such
                    benefits during the leave and pay the employee's share of
                    the premium payments. If the employee does not continue
                    these payments, the company will discontinue coverage during
                    the leave. If the company maintains coverage, the company
                    may recover the costs incurred for paying the employee's
                    share of any premiums, whether or not the employee returns
                    to work.
                  </Typography>
                </Grid>
                <Grid className="points-blk-inn">
                  ...
                  <Typography variant="body">
                    ...
                    provider. This requirement will be included in the company's
                    response to the FMLA request. Generally, an employee who
                    takes FMLA leave will be able to return to the same position
                    or a position with equivalent status, pay, benefits and
                    other employment terms. The position will be the same or one
                    that is virtually identical in terms of pay, benefits and
                    working conditions. The company may choose to exempt certain
                    key employees from this requirement and not return them to
                    the same or similar position when doing so will cause
                    substantial and grievous economic injury to business
                    operations. Key employees will be given written notice at
                    the time FMLA leave is requested of his or her status as a
                    key employee.
                  </Typography>
                </Grid>
                <Grid className="points-blk-inn">
                  ...
                  <Typography variant="body">
                    ...
                    vacation, personal or sick leave prior to being eligible for
                    unpaid leave. Sick leave may run concurrently with FMLA
                    leave if the reason for the FMLA leave is covered by the
                  ...
                  <Typography variant="body">
                    ...
                    the 12-week entitlement. An employee who is taking leave for
                    the adoption or foster care of a child must use all paid
                    vacation, personal or family leave prior to being eligible
                    for unpaid leave.
                  </Typography>
                  <Typography variant="body">
                    An employee who is using military FMLA leave for a
                    qualifying exigency must use all paid vacation and personal
                    leave prior to being eligible for unpaid leave. An employee
                    using FMLA military caregiver leave must also use all paid
                    vacation, personal leave or sick leave (as long as the
                    reason for the absence is covered by the company's sick
                ...
                <Grid className="points-blk-inn">
                  ...
                  <Typography variant="body">
                    ...
                    recognized in the state where the individual was married and
                    includes individuals in a common law or same-sex marriage.
                    Spouse also includes a husband or wife in a marriage that
                    was validly entered into outside of the United States, if
                    the marriage could have been entered into in at least one
                    state.
                  </Typography>
                  <Typography variant="body">
                    <b>Child</b> means a biological, adopted or foster child, a
                    stepchild, a legal ward, or a child of a person standing in
                    loco parentis, who is either under age 18, or age 18 or
                  ...
                  <Typography variant="body">
                    ...
                    parentis to the employee when the employee was a child. This
                  ...
                  <Typography variant="body">
                    ...
                    active duty, provided that the employer and employee agree,
                    including agreement on timing and duration of the leave.
                  </Typography>
                  <Typography variant="body">
                    <b>Covered active duty </b> for members of a regular
                    component of the Armed Forces, means duty during deployment
                    of the member with the Armed Forces to a foreign country.
                    For a member of the Reserve components of the Armed Forces,
                    means duty during the deployment of the member with the
                    Armed Forces to a foreign country under a federal call or
                    order to active duty in support of a contingency operation,
                    in accordance with 29 CR 825.102.
                  </Typography>
                  <Typography variant="body">
                    ...
                    uncles, and first cousins, unless the covered service member
                    has specifically designated in writing another blood
                    relative as his or her nearest blood relative for purposes
                  ...
                  <Typography variant="body">
                    <b>Serious injury or illness </b> is one that is incurred by
                    a service member in the line of duty on active duty that may
                    cause the service member to be medically unfit to perform
                    the duties of his or her office, grade, rank or rating. A
                    serious injury or illness also includes injuries or
                    illnesses that existed before the service member's active
                    duty and that were aggravated by service in the line of duty
                    on active duty.
                  </Typography>
                </Grid>
              </Grid>
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  responsibilities by serving jury duty when required, and will
                  not interfere, discharge, or discourage an employee who is
                ...
                <Typography variant="body">
                  Employees must show the jury duty summons to their supervisor
                  as soon as possible so that the supervisor may make
                  arrangements to accommodate their absence. Of course,
                ...
                <Typography variant="body">
                  The employee must notify his or her supervisor each day he or
                  she is scheduled to report for jury duty.
                </Typography>
                <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  employees are able to find time to vote either before or after
                  their regular work schedule. If employees are unable to vote
                  in an election during their non-working hours, employer will
                  grant up to 2 hours of paid time off to vote.
                </Typography>
                <Typography variant="body">
                  Employees should request time off to vote from their
                  supervisor at least 2 working days prior to the Election Day.
                  Advance notice is required so that the necessary time off can
                  be scheduled at the beginning or end of the work shift,
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  and Reemployment Rights Act (USERRA). Advance notice of
                  military service is required, unless military necessity
                  prevents such notice, or it is otherwise impossible or
                  unreasonable.
                </Typography>
                <Typography variant="body">
                  Military leave will be unpaid. However, employees may use any
                  paid leave otherwise available to employee in accordance with
                  other provisions of this manual. However, benefit accruals,
                  such as paid time off (PTO) or holiday benefits, will be
                  suspended during any military leave and will resume upon the
                  employee’s return to active employment.
                </Typography>
                <Typography variant="body">
                  Employees on military leave for up to 30 days are required to
                  return to work for the first regularly scheduled shift after
                  the end of service, allowing reasonable travel time. Employees
                  ...
                  will be treated as though they were continuously employed for
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  In accordance with applicable law, the Company will provide a
                  reasonable amount of break time to accommodate a female
                  employee's need to express breast milk for the employee's
                  infant child.
                </Typography>
                <Typography variant="body">
                  The break time should, if possible, be taken concurrently with
                  other break periods already provided. Non- exempt employees
                  should clock out for any time taken that does not run
                  concurrently with normally scheduled rest periods, and such
                  time generally will be unpaid, in accordance with state law.
                  The Company will also make a reasonable effort to provide the
                  employee with the use of a room or other location in close
                  proximity to the employee's work area, for the employee to
                  express milk in private.
                </Typography>
                <Typography variant="body">
                  Notify Management to request time to express breast milk under
                  this policy. The Company reserves the right to deny an
                  employee's request for a lactation break if the additional
                  break time will seriously disrupt operations and in accordance
                  with applicable law.
                </Typography>
                <Typography variant="body">
            ...
            <Grid className="points-sec">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  not receive the check for another employee, nor can members of
                  the family receive the check for an employee without a written
                  request.
                </Typography>
                <Typography variant="body">
                  Federal withholding taxes and social security taxes will be
                  withheld from all compensation paid to the employee, as
                  required by law. In addition to payroll withholdings required
                  by law, if authorized a voluntary written authorization from
                  the employee, The Company will deduct amounts necessary to pay
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  records of time worked in order to calculate employee pay and
                  benefits. Time worked is all the time actually spent on the
                  job performing assigned duties in furtherance of The Company’s
                  business.
                </Typography>
                <Typography variant="body">
                  Employees should accurately record the time they begin and end
                  their work. They should also record the beginning and ending
                  time of any split shift or departure from work for personal
                  reasons, including but not limited to leaving the Company for
                  a meal break.
                </Typography>
                <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  the accuracy of all time and hours worked in each work period
                  and the amount of earnings before receiving their paychecks.
                  The supervisor will review and then initial the time record
                  before submitting it for payroll processing. If corrections or
                  modifications to the employee’s time record are needed, both
                  the employee and the supervisor must document and verify those
                  changes by initialing the time record.
                </Typography>
                <Typography variant="body">
                  It is a violation of The Company’s policy for an employee to:
                  (1) record time in or out for another employee, recording time
                  on another employee’s time record or otherwise on behalf of
                  another employee; (2) work in excess of the employee’s
                  scheduled work hours without prior authorization from his or
                  her supervisor; (3) failing to verify the accuracy of the
                  employee’s paycheck; and (4) altering, falsifying or tampering
                  with any time or payroll related records, except as permitted
                ...
                <Typography variant="body">
                  ...
                  the manager or shift leader to make the necessary adjustment.
                  Habitual failure to clock out shall be grounds for
                  termination.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  and that employees are paid promptly on the scheduled payday.
                  In the unlikely event that there is an error in the amount of
                  pay, the employee should promptly bring the discrepancy to the
                  attention of his or her supervisor or department head, in
                  accordance with the above payroll and time clock policies and
                  procedures, so that all necessary corrections can be timely
                  resolved.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  advance by the supervisor or Company Administrator. Employees
                  whose travel plans have been approved are responsible for
                ...
                <ul>
                  ...
                  <li>Refreshments</li>
                  <li>
                    Gas with appropriate and approved receipts for travel within
                ...
                <Typography variant="body">
                  Training, rental cars, hotel and airfare will be booked by the
                  Company in advance.
                </Typography>
                <Typography variant="body">
                  When an employee uses his or her own vehicle for The Company’s
                  business-related travel outside the city or town where an
                  employee’s normal work location is, The Company will reimburse
                  the employee at a predetermined rate per mile.
                </Typography>
                <Typography variant="body">
                ...
                <Typography variant="body">
                  The company will provide a reasonable amount of break time to
                  accommodate a female employee's need to express breast milk
            ...
            <Grid className="points-sec">
              <Typography variant="h5">V. WORK HOURS AND CONDITIONS</Typography>
              <Grid className="points-blk">
                <Typography className="h6">A. Work Hours</Typography>
                <Typography variant="body">
                  The Company’s work hours for office personnel shall be
                  dictated by the needs of the position. The Company’s operating
                  hours are 7 a.m. to 3 a.m.
                </Typography>
                <Typography variant="body">
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  enough to be at his or her assigned area by the time scheduled
                  work begins.
                </Typography>
                <Typography variant="body">
                ...
                <Typography variant="body">
                  ...
                  employee from reporting for duty, the employee must make every
                  effort to speak to Management directly, rather than leaving a
                  phone message, prior to time to report for duty.
                </Typography>
                <Typography variant="body">
                ...
                <Typography variant="body">
                  The Company recognizes that, due to unforeseen circumstances,
                  employees may be late getting to work. Whenever possible,
                  employees should inform Management to advise of the expected
                  arrival time to work.
                </Typography>
                <Typography variant="body">
                  Excessive tardiness or absenteeism may result in disciplinary
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  time other than their assigned shift without specific approval
                  from their supervisor or department head. Employees who work
                  overtime without authorization may be subject to discipline,
                  up to and including termination.
                </Typography>
                <Typography variant="body">
                  In the event of an emergency, The Company may ask employee(s)
                  to work hours in excess of their regular schedule, as needed.
                </Typography>
                <Typography variant="body">
                  PTO, paid holidays, bereavement leave, and other paid absences
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  ...
                  consistent with federal, state, and local laws. Employees are
                  allowed to leave your work area when necessary for restroom
                  breaks and refreshments without clocking out. Abuse of break
                  periods may result in discipline or termination.
                </Typography>
                <Typography variant="body">
                  All employees are required to clock out at the beginning of
                  the meal break and clock back in once the allowed meal break
                  ends and upon starting back to work. If an employee is unable
                  to take a meal break, the employee should inform Management.
                  Working meal breaks during which time the employee performs
                  work while also breaking shall be compensated as working time.
                </Typography>
              </Grid>
              <Grid className="points-blk">
                <Typography className="h6">
                ...
                <Typography variant="body">
                  ...
                  Company’s facilities, only authorized visitors are allowed in
                  the workplace. Restricting unauthorized visitors helps
              ...
              <Grid className="points-blk">
                ...
                <Typography variant="body">
                  <b>
                    THE COMPANY STRICTLY PROHIBITS ANY EMPLOYEE’S CONSUMPTION OF
                    ALCOHOL WHILE ON THE JOB. VIOLATIONS OF THIS POLICY SHALL BE
                    CONSIDERED MISCONDUCT AND GROUNDS FOR IMMEDIATE TERMINATION.
                  </b>
                </Typography>
                <Typography variant="body">
                  ...
                  liability of The Company. Each employee is an important asset
                  to us, and we look forward to safe company sponsored
                  activities.
                </Typography>
                <Typography variant="body">
                  All bartenders and servers shall take a Texas Alcoholic
                  Beverage Code commission-approved seller training program and
                  provide certificate of completion as a condition of employment
                  and continued employment.
                </Typography>
                <Typography variant="body">
                  All bartenders and servers are required to be alert and
                  observe the patrons’ consumption of alcohol while on duty. Any
                  bartender or server who believes any patron has become
                  ...
                  management shall immediately call 911 to report the incident,
                  making the patron’s name, identifying description of person
                  and vehicle, and license plate (as much information as
              ...
              <Grid className="points-blk">
                ...
                <ul className="num-list">
                  <li>
                    Employees shall not sell or provide cigarettes, e-cigarettes
                    and/or tobacco products, or give coupons for cigarettes,
                    e-cigarettes or tobacco purchases to any person under 21
                    years of age. A violation is a Class C misdemeanor;
                  </li>
                  <li>
                    Employees shall request proof of age from any person under
                    30 years of age who attempts to purchase cigarettes,
                    e-cigarettes or tobacco products. Retailers may be fined up
                    to $1,000 per violation or have their permit revoked or
                    suspended for selling cigarettes, e-cigarettes or tobacco
                    products to any person under 21 years of age;
                  </li>
                  <li>
                    Employees may be subject to criminal prosecution for a Class
                    C misdemeanor if, with criminal negligence, they sell
                    cigarettes, e-cigarettes and/or tobacco products to any
                  ...
                  <li>
                    ...
                    the penalties for violations of the law. Employees shall not
                    remove this sign.
                  </li>
                  <li>
    ...
    <FormControl>
      ...
      <Grid className='select-opt'>
       ...
       <Grid container spacing={3} columns={12} className='flx-box'>
        ...
        <Grid container spacing={3} columns={12} className='btm-button' mt={5}>
       <Grid item xs={6}></Grid>
       <Grid item xs={6}>
